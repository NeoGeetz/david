...
metal_detect_stats* mptr ;//mptr +1 => address in memory that is mptr + (1 * sizeof(metal_detect_stats) ~408)

typedef struct {
    //could do ding_ptr = (some_array + 20) to make it point into the middle of some array
